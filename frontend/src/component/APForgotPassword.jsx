...
export default function APForgotPassword({resetEmail, setResetEmail, handleForgotPassword, handleCancelForgotPassword}) {
        ...
        <div className="bg-white shadow sm:rounded-lg">
            <div className="px-4 py-5 sm:p-6">
                ...
                <div className="mt-2 max-w-xl text-sm text-gray-500">
                    <p>Input your email account for password reset.</p>
                </div>
