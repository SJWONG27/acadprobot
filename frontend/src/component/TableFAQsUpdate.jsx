import APAddFAQs from "./APAddFAQs"
import { useState } from "react"

const items = [
    { question: 'What is UM expert website?', answer: 'https://umexpert.um.edu.my/' },
    // More people...
]

export default function TableFAQsUpdate() {
        ...
        <div>
            <div className="sm:flex sm:items-center">
                <div className="sm:flex-auto">
                    <h1 className="text-base font-semibold text-gray-900">Frequently Asked Questions</h1>
                    <p className="mt-2 text-sm text-gray-700">
                        A list of FAQs to be displayed when prompted.
                    </p>
                </div>
