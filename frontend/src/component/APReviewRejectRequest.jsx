...
export default function APReviewRejectRequest() {

    const {
        handleRejectRequest,
        requestRemark,
        setRequestRemark,
        setShowAPReviewRejectRequest
        ...
        <div className="bg-white shadow sm:rounded-lg">
            <div className="px-4 py-5 sm:p-6">
                ...
                <div className="mt-2 max-w-xl text-sm text-gray-500">
                    <p>Add remarks for the rejection</p>
                </div>
                <form className="mt-5 flex flex-col sm:items-center">
                    ...
                    <div className="flex flex-row mt-6">
                        <button
                            ...
                            onClick={()=>{
                                handleRejectRequest();
                                setShowAPReviewRejectRequest(false);
                            }}
                        ...
                        <button
                            type="button"
                            onClick={()=>setShowAPReviewRejectRequest(false)}
