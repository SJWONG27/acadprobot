...
const Chat = () => {
  ...
  const handleSend = async () => {
    ...
    try {
      ...
      console.error("Request handkeSend failed:", error);
    }
  };
  ...
  return (
    <div className="w-screen h-screen flex flex-row relative">
      ...
      <div className={`h-full w-min bg-white border border-gray-200 drop-shadow transform transition-transform duration-800 ease-in-out ${isSidebarOpen ? 'translate-x-0 absolute z-20  sm:relative' : '-translate-x-full w-0'}`}>
        <ChatSideBar
